...
export const MODULES: ModuleDef[] = [
  ...
  {
    id: 'module-8',
    titleEn: 'Material & Information Flow',
    titleJa: '物と情報の流れ図',
    subtitleEn: 'Map the full flow of a factory before you can improve it',
    subtitleJa: '改善の前に工場全体の流れを描く',
    icon: '🗺',
    belt: 'blue',
    xpReward: 160,
    steps: [
      { id: 'step-1', titleEn: 'The Assignment', titleJa: '任務', type: 'reflection', durationMin: 5 },
      { id: 'step-2', titleEn: 'Symbol Reference', titleJa: '記号リファレンス', type: 'observation', durationMin: 10 },
      { id: 'step-3', titleEn: 'Symbol Recognition', titleJa: '記号識別', type: 'quiz', durationMin: 10 },
      { id: 'step-4', titleEn: 'Read the Map', titleJa: 'マップを読む', type: 'observation', durationMin: 15 },
      { id: 'step-5', titleEn: 'Build the Map', titleJa: 'マップを描く', type: 'builder', durationMin: 25 },
      { id: 'step-6', titleEn: 'Find the Waste', titleJa: '無駄を発見する', type: 'drill', durationMin: 15 },
      { id: 'step-7', titleEn: 'Field Assessment', titleJa: 'フィールド評価', type: 'simulation', durationMin: 10 },
    ],
  },
  {
    id: 'module-9',
